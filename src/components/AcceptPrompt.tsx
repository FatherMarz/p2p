...
export default function AcceptPrompt({ transfer }: { transfer: Transfer }) {
  ...
  return (
    <div className="tile p-6" data-testid="accept-prompt">
      <div className="stamp mb-4">Incoming File</div>
      ...
      <div className="mt-5 flex gap-3">
        <button className="btn btn-primary" onClick={() => void accept()} disabled={busy} data-testid="accept-btn">
          Accept &amp; save
        </button>
